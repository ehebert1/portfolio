const data = {
    ...
    "fr": {
        ...
        "projects-encage-my-role-content": "Du point de vue de la programmation, nous avions deux grandes parties dans le projet, soit l'intelligence artificielle ainsi que les commandes que notre personnage principal doit compléter. Ces deux parties ont portés différents défis que nous avons du relevé pour que notre jeu puisse avoir un <i>gameplay</i> qui transporte les joueurs au Québec au début du 20<sup>e</sup> siècle.",
