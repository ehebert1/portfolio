const data = {
    "en": {
        ...
        "about-me-csharp-content": "C# is the first programming language I have learned. Since its structure is simple, it is probably my favourite programming language to use. I have developed multiple console applications, form applications, backend server code for website applications as well as making video games using the Unity game engine.",
        ...
        "about-me-introduction": "I am Éric Hébert and I am a bachelor in video game development from the University of Québec at Chicoutimi. Ever since I was young, I have been interested by computers and video games. I remember as a child playing on the Nintendo 64 with my brothers or even playing Runescape on our computers. This passion, growing since childhood, brought me to divert from website development and change my path towards video game development.",
        ...
        "about-me-js-content": "JavaScript is a language you need to master to do modern website development. I have had the chance to use JavaScript in a variety of different ways and with a lot of different libraries. I have used jQuery, VueJS and I have used the PhaserJS game engine, which allows you to create 2D video games on a webpage. I have also used TypeScript, which is a JavaScript that forces you to use object typing.",
        "about-me-skills": "Skills",
        "about-me-skills-content": "",
        "about-me-sql-title": "SQL",
        "about-me-sql-content": "SQL is a language that is essential to manage large quantities of data. The two types of databases I have used are Microsoft SQL Server and MySQL. I have also used SQL with websites, mostly while using ASP.NET MVC with Entity Framework, Laravel with MySQL and Adobe ColdFusion with Microsoft SQL Server.",
        "about-me-steam-title": "Steam",
        "about-me-steam-content": "With the making of my latest project, I have familiarized myself with the integration of the Steam sdk. I can install the SDK in a project as well as integrating achievements as well as other things.",
        "about-me-studies": "Studies",
        "about-me-unity-title": "Unity",
        "about-me-unity-content": "I have used Unity multiple times through my time at university. It is also the first game engine I have learned. I am familiar with gameplay programming as well as network programming using Networking with GameObjects (NGO) et and I also made a virtual reality game using this engine.",
        ...
        "about-me-unreal-title": "Unreal Engine",
        "about-me-unreal-content": "I have used Unreal Engine quite a bit throughout my university studies. I have done as much C++ programming as blueprints. I am familiar with gameplay programming as well as AI development and I have a foundation in network programming using this engine. I am currently trying to get familiar with network programming using this engine. I am familiar with Unreal Engine 4 and 5.",
        "about-me-work": "Professional Experience",
        ...
        "about-me-work-eckinox-content": "For this position, we have collaborated with <i>Eckinox</i> and <i>Totema Studio</i> to create the games for the platform. I had to learn a new game engine as well as multiple web technologies for the realization of the project. Also, I had to collaborate with other developers for the creation of the games and the code structure, as well as integrating the API developed to save the player's statistics. We also used multiple project management tools, such as daily scrums and a ticketing tool, in our case, Jira.",
        ...
        "developer-info-content": "I am Éric Hébert, a student in video game development at Université du Québec à Chicoutimi. I am capable with multiple game engines, notably Unreal Engine, Unity 3D and PhaserJS. I invite you to browse my site.<br><br>I am currently looking for work in the video game industry. I am also working on my skills in network programming using the Unreal Engine game engine.",
        "empty": "",
        "home": "Home",
        "lang": "FR",
        "projects": "Projects",
        ...
        "projects-bambooza-cauldron-content": "The second game I have made for this platform is the cauldron. This game was a whole lot more difficult to make than the labyrinth. This game has a goal to help improve the organization of the player. This game has a lot of different components, notable the ingredients, the recipes and the bowls. The most difficult part to make for this game was the bowls.",
        "projects-bambooza-cauldron-bowl": "Bowl",
        "projects-bambooza-cauldron-bowl-content": "The utilization of the bowls is the most important for this game since it is the tool that is used to better understant the importance of organizing yourself within the workspace. In this game, there are five different bowls that allow the player to better organize the ingredients according to their own preferred way of organization. The most difficult part to develop in this system was the reorganization of the ingredients inside the bowl.",
        "projects-bambooza-cauldron-bowl-reorganisation": "Reorganization of the ingredients",
        "projects-bambooza-cauldron-bowl-reorganisation-content": "We have three different ways to reorganize the ingredients, placing the ingredient at the end of the bowl, placing the ingredient in between two ingredients already in the list and exchanging positions of two ingredients. To place the ingredient at the end of the bowl, we just need to place the ingredient on the bowl when it is closed or put the ingredient at the most bottom part of the bowl when it is opened. To place an ingredient between two ingredients, we need to put it in between two ingredients in the same row. To exchange the place between two ingredients, we need to place on ingredient on top of another one in the same bowl.",
        "projects-bambooza-cauldron-recipes": "Recipes and Ingredients",
        "projects-bambooza-cauldron-recipes-content": "The main goal of this game is to complete the recipes displayed above the cauldron using the ingredients provided on the right of the cauldron. However, there are a lot of ingredients available and they pile up one on top of the other and it becomes a gruesome task to accomplish. We have made it possible to reuse the ingredients since they appear in multiple recipes and this forces the players to properly organize themselves to be able to quickly locate the ingredients required for the recipe. For the ingredients and the recipes, I had to use the API provided by Eckinox to integrate them into the game. To complete the recipes, all you need to do is to drag the ingredients onto the cauldron and it will be added to the recipe. To make it easier for the players and to help them improve their organization, we have created bowls to organize the ingredients.",
        "projects-bambooza-challenges": "Conception Challenges",
        "projects-bambooza-challenges-content": "The biggest conception challenges for this project was to collaborate with multiple teams on this project. We needed to collaborate with multiple different teams during the production for different aspects of the project, notably with Totema Studio for the development of the games for the platform and with Eckinox for all the web technologies used for this project.",
        "projects-bambooza-labyrinth": "Labyrinth",
        "projects-bambooza-labyrinth-content": "The first game I made for the platform was the Labyrinth. The game is pretty simple, it's a game where there is a question and two possible answers and when we answer correctly, we go forward in the labyrinth. There are two things that took longer to develop, the integration of the questions and displaying the progress inside the labyrinth.",
        "projects-bambooza-labyrinth-integration": "Integration of the Questions",
        "projects-bambooza-labyrinth-integration-content": "For the integration of the questions, we initially thought of using a JSON file that would contain all the questions and answers. The questions would be made of a couple of attributes, notably the text of the question, the color of the text, as well as the possible answers. The answers would also have a little bit of information, like the text as well as if it is the right answer. This system worked fine, but it does not allow to add questions and answers dynamically. Because of that, we have decided to change that system, while keeping the same attributes, but we would keep the questions and answers on a database the clients can access so they can add/delete/modify the questions by using a web interface. We then needed to implement the API made by Eckinox to retrieve the questions and answers.",
        ...
        "projects-encage-ai-detection-content-next": "Next is the visual detection of the bird. The detection only occurs when the character is in the 60 degree field of view in front of the bird in the small circle shown in the picture above. The visual sense is more punishing for the player than the sound sense since the bird will feel more at risk since the character is close to the bird. We also had a bug regarding the detection that would prevent the sound and visual sense from being detected at the same time. I had to dig deeper into the Unreal Engine game engine, but I finally found the variable where all the senses are stored and I can see individually if they are activated. Therefore, every time the perception is updated, I verify whether each sense is activated. Once the detection is done, we have a function that gets triggered every 50 milliseconds that will change the deteection force on the bird and when the bird reaches a specific threshold, it will fly away from the player.",
        "projects-encage-challenges": "Conception challenges",
        "projects-encage-challenges-content": "The biggest hurdle during our concept was without a doubt the creation of the artificial intelligence of our bird. We have dedicated 4 sprints to complete it, which is nearly 2 months. Even though we had a lot of experience and skills as developers, we had little to no experience using artificial intelligence and it is incredibly more difficult to debug artificial intelligence than it is to debug anything we have debugged before, such as JavaScript in website applications, console applications in C++ or C# or even mobile applications in Java. There were a lot of times where we spent multiple hours debugging a behaviour within our artificial intelligence, just for us to change one condition in the decision making for it to work properly. However, this challenge has allowed us to familiarize ourselves with artificial intelligence within Unreal Engine and we are now able to make complex behaviours with this tool.",
        "projects-encage-challenges-content-next": "Another challenge we faced was to collaborate with artists from the NAD school (School of numerical arts, of animation and of design) for the creation of our game. Even though the experience was amazing and removed a big weight off our shoulders, it was still something we had to adapt to since it was a new experience to work with artists. There were two major things we had to do when collaborating with them, such as making sure communicate regularly with our game designer to make sure we were going in the right direction when developing our artificial intelligence and when we were developing the orders, and making sure we were exposing the right variables in order for the technical artist to link the code to the visual.",
        "projects-encage-introduction": "<i>Héritage</i> is a story game that invites you to question intergenerational beliefs and practices. You play a young Québec woman in the early 20<sup>th</sup> century who inherited the family's company. Rediscover your childhood memories, complete orders and dive into the story of this young woman and her generational company.",
        ...
        "projects-encage-my-role-content": "From the programming standpoint, there were two main parts to this project, the artificial intelligence as well as the orders that the main character must complete. Both of these parts has brought us numerous challenges that we had to overcome in order bring the players to experience the early 20<sup>th</sup> century in Quebec within our gameplay.",
        "projects-encage-oa": "Obstacle avoidance",
        "projects-encage-oa-introduction": "An integral part of the movement of our artificial intelligence was the obstacle avoidance. This brought us a lot of challenges and troubles, since the behaviour that came out of some of our iterations were pretty atrocious. Here are some examples of behaviours that we have seen while testing our obstacle avoidance behaviour:",
        ...
        "projects-hamstorm-myrole-content": "For this project, I joined a team of artists that made a prototype of the game the previous semester. We are two programmers that joined the team for the semester. To make it to the final product, we needed to redo the mechanics in C++ and implement the new game mechanics. We needed to implement the turn-by-turn movement, including the movement of the main character and the enemies, the destruction of the environment, the enemy behaviors, the camera management as well as being able to revert turns.",
        "projects-hamstorm-post-imaginad": "Post Imagi<i>NAD</i>",
        "projects-hamstorm-post-imaginad-content": "After the <i>ImagiNAD</i> event, we wanted to make some changes to polish some elements of the game as well as adding some details before we publish it to Steam. From the programming side, we wanted to fix some bugs and do some quality-of-life work, rename the project as well as integrating Steam and the achievements.",
        "projects-hamstorm-rename-project": "Renaming the project",
        "projects-hamstorm-rename-project-content": "We wanted to rename the project since the project name in Unreal Engine dictates the name of the executable file when you make a build of your game. Since we want to publish the game on Steam, we wanted to name the game Hamstörm rather than <i>DH_Synthese</i>. To rename an Unreal Engine project, there is not an easy way to do it, as a matter of fact <a href=\"https://www.youtube.com/watch?v=HzQhO8nxeI8\" target=\"blank\">Unreal Engine made their own tutorial</a> on the matter. However, this tutorial does not cover the C++ part of renaming the project. For the C++ part, there are multiple steps we need to take to make it possible. Firstly, we need to change the name of the classes of the build files and edit the references to the old project name to the new name. Then, you need to change the API name of the project in all the header files. In our case, we changed from <i>DH_SYNTHESE_API</i> to <i>HAMSTORM_API</i>. Finally, we need to add a reference in the <i>DefaultEngine.ini</i> file which creates a redirection from the old folders to the new C++ classes folder. This allows all the blueprints which inherited from a C++ class from the project to find their parent's class definition.",
        "projects-hamstorm-revert": "Reverting Turns",
        "projects-hamstorm-revert-content": "We started implementing the reverting system around the middle of the semester. This mechanic added a new complexity to the functionalities of the game since every user action as well as the actions of the environment needs to be recorded and needs to be recorded in order and in the right turn. At the beginning, the definition of a turn was really simple, a turn starts when the player can take actions and ends when the enemies end their movements. However, this has brought a lot of bugs to the game due to this definition.",
    ...
    "fr": {
        ...
        "about-me-skills-content": "",
        "about-me-steam-title": "Steam",
        "about-me-steam-content": "Avec mon projet le plus récent, je me suis familiarisé avec l'intégration du SDK de Steam. Je suis capable de l'installer dans un projet ainsi que de l'utiliser pour intégrer des <i>achievements</i> et plusieurs autres choses.",
        "about-me-sql-title": "SQL",
        ...
        "about-me-unity-title": "Unity",
        "about-me-unity-content": "J'ai utilisé Unity à plusieurs reprises au cours mon parcours universitaire. C'est aussi le premier moteur que j'ai appris. Je suis familier avec la programmation gameplay ainsi que la programmation réseau avec <i>Networking with GameObjects (NGO)</i> et j'ai aussi fait un jeu en réalité virtuelle avec ce moteur.",
        "about-me-university": "Université du Québec à Chicoutimi",
        ...
        "about-me-unreal-title": "Unreal Engine",
        "about-me-unreal-content": "J'ai beaucoup utilisé Unreal Engine au cours de mon parcours universitaire. J'ai fait autant de programmation en C++ que les blueprints. Je suis familier avec la programmation gameplay ainsi que la programmation d'IA et j'ai des bases en programmation réseau à l'aide de ce moteur de jeu. Je suis présentement en train de me familiariser avec la programmation multijoueur avec ce moteur. Je suis familier avec Unreal Engine 4 et 5.",
        "about-me-work": "Expérience professionnelle",
        "about-me-work-cra": "Développeur de Technologie informatique",
        "about-me-work-cra-content": "Mon emploi à l'Agence du revenu du Canada est mon premier emploi en informatique. Cet emploi m'a permis d'obtenir mes bases de mes compétences professionnelles, notamment la communication avec des clients et de collègues, le développement dynamique, la gestion de données personnelles, ainsi que la documentation de code. Pour cet emploi, j'ai aussi appris un nouveau langage de programmation et j'ai développé des systèmes de données.",
        ...
        "developer-info-content": "Je suis Éric Hébert, un étudiant en développement de jeux vidéo à l'Université du Québec à Chicoutimi. Je suis habile avec plusieurs moteur de jeux, notamment Unreal Engine, Unity 3D ainsi que PhaserJS. Je vous invite à naviguer mon site.<br><br>Je suis présentement à la recherche d'un emploi dans l'industrie du jeu vidéo. Je suis aussi en train d'améliorer mes habiletés en programmation réseau à l'aide du moteur <i>Unreal Engine</i>.",
        "empty": "",
        "home": "Accueil",
        "lang": "EN",
        "projects": "Projets",
        ...
        "projects-bambooza-labyrinth-integration-content": "Pour l'intégration des questions, nous avions pensé initialement faire un fichier JSON qui contient les questions. Les questions seraient composées de quelques attributs, soit le texte de la question, la couleur du texte, ainsi que les réponses possibles. Les réponses auraient aussi quelques informations, notamment le texte ainsi que si c'est la bonne réponse. Ce système fonctionnait bien, mais il ne permettait pas d'ajouter des questions/réponses dynamiquement. Nous avons opté pour changer le système, en gardant les attributs, mais en gardant les questions et réponses dans une base de données que les clients pouvaient accéder pour ajouter/supprimer/modifier des questions à l'aide d'une interface web. Nous devions donc changer l'implémentation pour utiliser l'API développé par <i>Eckinox</i> pour récupérer les questions et réponses.",
        "projects-bambooza-labyrinth-progress": "Progrès dans le labyrinthe",
        "projects-bambooza-labyrinth-progress-content": "Un des aspects visuels qui était important pour le jeu est de voir le progrès du joueur dans le labyrinthe lorsqu'il complète les questions. Pour ce faire, on voulait vraiment que la barre de progrès complète le labyrinthe au lieu que ce soit une barre de progrès normale. Pour l'implémenter, nous avons établi des points dans le labyrinthe qui permet de situer les intersections du labyrinthe. Ensuite, nous avons créé des objets qui nécessite deux de ces points pour faire une ligne et nous gardons la longueur totale pour la barre. Par après, avec le pourcentage de questions répondues, nous remplissons la barre de progrès. Nous avons aussi dû adapter le visuel pour les différentes résolutions d'écran.",
        ...
        "projects-encage-introduction": "<i>Héritage</i> est un jeu narratif qui vous invite à remettre en question les préconceptions et croyances générationnelles. Vous incarnez une jeune fille québécoise dans les années 1910 ayant hérité de son entreprise familiale. Redécouvrez vos souvenirs d'enfance, complétez des commandes et plongez-vous dans l'histoire de cette jeune fille et de son commerce familial.",
        "projects-encage-introduction-title": "Introduction",
        ...
        "projects-encage-seeds-content": "Pour la continuation du jeu, nou voulions introduire une nouvelle mécanique dans le jeu pour ajouter un nouveau niveau de complexité dans le jeu. Nous avons décidé d'ajouter une mécanique d'appât sous la forme de graines dans le but d'attirer les oiseaux en un point pour pouvoir ensuite les capturer. Ceci a aussi permis à notre designer de niveaux de placer des oiseaux en hauteur et de les rendre inaccessible aux joueurs à moins d'utiliser notre mécanique d'appâts.",
        ...
        "projects-hamstorm-link": "<a href=\"https://store.steampowered.com/app/2944680/Hamstrm/\" target=\"_blank\" class=\"card-url\"><div><strong>Jouez à Hamstörm gratuitement sur Steam!</strong></div></a>",
        ...
        "projects-hamstorm-post-imaginad": "Post <i>ImagiNAD</i>",
        "projects-hamstorm-post-imaginad-content": "Après l'<i>ImagiNAD</i>, nous avons fait quelques changements pour pouvoir peaufiner la fin du projet et améliorer quelques petits détails avant de le publier sur Steam. Du côté de la programmation, nous avions quelques <i>bug fixes</i> et <i>quality of life</i>, renommer le projet ainsi qu'intégrer <i>Steam</i> et les <i>achievements</i>.",
        "projects-hamstorm-rename-project": "Renommer le projet",
        "projects-hamstorm-rename-project-content": "Nous voulions renommer le projet puisque le nom du projet <i>Unreal</i> est le nom du fichier exécutable lorsque l'on fait un build. Puisque nous voulions publier le jeu sur Steam, nous voulions que le jeu s'appelle <i>Hamstorm</i> au lieu de <i>DH_Synthese</i>. Pour renommer un projet Unreal Engine, il n'y a pas de manière très facile de le faire, tel que <a href=\"https://www.youtube.com/watch?v=HzQhO8nxeI8\" target=\"blank\"> Unreal Engine a fait son propre tutoriel</a> à ce sujet. Cependant, ce tutoriel ne couvre pas la partie C++ pour renommer le projet. Pour la partie C++, il y a plusieurs étapes à suivre pour le rendre possible. Premièrement, il faut changer les noms de classes des fichiers de <i>build</i> et modifier les références de l'ancien nom du projet vers le nouveau nom. Ensuite, il faut changer le nom de l'API du projet dans tous les fichiers d'en-tête (les <i>.h</i>), donc dans notre cas de <i>DH_SYNTHESE_API</i> vers <i>HAMSTORM_API</i>. Finalement, il faut ajouter une référence dans le fichier <i>DefaultEngine.ini</i> qui fait une redirection des anciens dossiers vers le nouveau dossier de classes C++. Ceci fait en sorte que tous les blueprints qui ont été créé une classe C++ du projet vont pouvoir retrouver la définition de leur classe parent.",
        "projects-hamstorm-revert": "Reculer de tours",
        "projects-hamstorm-revert-content": "Nous avons commencé à implémenter le système de retour en arrière vers la mi-session. Cette mécanique ajoute une complexité au niveau du fonctionnement de notre système puisque chaque action utilisateur et chaque action de l'environnement doit être enregistrée et elle doit être enregistrée en ordre d'exécution et dans le bon tour. Initialement, notre définition de tour était assez simple, le tour commence dès que le joueur peut faire des actions et elle se termine lorsque tous les ennemis ont fini de se déplacer. Cependant, ceci a apporté plusieurs bugs dans notre application dû à cette définition.",
